    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-sm w-full space-y-6">
        ...
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900">Sign up for Frappe</h2>
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <input
                  ...
                  className="block w-full px-3 py-1  rounded-lg bg-gray-100 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent text-sm"
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-9 pr-3 py-1 rounded-lg bg-gray-100 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent text-sm"
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-9 pr-16 py-1 rounded-lg bg-gray-100 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent text-sm"
