    ...
    <div className="p-6 bg-gray-50 min-h-full">
      <div className="max-w-full mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            onClick={() => {
              // Dispatch custom event to change activeContent to 'recruitment-dashboard-form'
              const event = new CustomEvent('setActiveContent', { detail: 'recruitment-dashboard-form' });
              window.dispatchEvent(event);
              // Update URL
              window.history.pushState({ activeContent: 'recruitment-dashboard-form' }, '', '/');
            }}
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <div className="divide-y divide-gray-200">
            {recruitmentDashboards.map((dashboard) => (
              <div 
                key={dashboard.id}
          ...
          <div className="px-6 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
            <span className="text-sm text-gray-600">{recruitmentDashboards.length} of {recruitmentDashboards.length}</span>
            <button className="text-gray-400 hover:text-red-500">
