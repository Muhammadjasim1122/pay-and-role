...
export default function Recruitment() {
  ...
  // Recruitment shortcuts data
  const recruitmentShortcuts = [
    { name: 'Job Opening', extra: '0 Open', link: '#' },
    { name: 'Job Applicant', extra: '0 Open', link: '#' },
    { name: 'Job Offer', extra: '0 Accepted', link: '#' },
    { name: 'Dashboard', link: '#' },
  ];

  // Recruitment reports and masters data
  const recruitmentReportsAndMasters = [
    {
      category: 'Jobs',
      items: [
        { name: 'Staffing Plan', link: '#', hasArrow: true },
        { name: 'Job Requisition', link: '#', hasArrow: true },
        { name: 'Job Opening', link: '#', hasArrow: true },
        { name: 'Job Applicant', link: '#', hasArrow: true },
        { name: 'Job Offer', link: '#', hasArrow: true },
        { name: 'Employee Referral', link: '#', hasArrow: true },
      ],
    },
    {
      category: 'Interviews',
      items: [
        { name: 'Interview Type', link: '#', hasArrow: true },
        { name: 'Interview Round', link: '#', hasArrow: true },
        { name: 'Interview', link: '#', hasArrow: false },
        { name: 'Interview Feedback', link: '#', hasArrow: false },
      ],
    },
    {
      category: 'Appointment',
      items: [
        { name: 'Appointment Letter Template', link: '#', hasArrow: true },
        { name: 'Appointment Letter', link: '#', hasArrow: false },
      ],
    },
    {
      category: 'Reports',
      items: [
        { name: 'Recruitment Analytics', link: '#', hasArrow: true },
      ],
    },
  ];
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          ...
          <div className="px-6 py-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {recruitmentShortcuts.map((shortcut) => (
                <a
                  key={shortcut.name}
                  href={shortcut.link}
            ...
            <div className="grid grid-row-5 gap-6">
              ...
              <div className="col-span-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  {recruitmentReportsAndMasters.map((category) => (
