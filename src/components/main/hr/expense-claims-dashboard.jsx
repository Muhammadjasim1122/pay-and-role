...
export default function ExpenseClaimsDashboard() {
  const { expenseClaimsDashboards } = useDashboard();
  ...
  const filteredDashboards = expenseClaimsDashboards.filter(dashboard => {
    ...
    <div className="p-6 bg-gray-50 min-h-full">
      <div className="max-w-full mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            onClick={() => {
              const event = new CustomEvent('setActiveContent', { detail: 'expense-claims-dashboard-form' });
              window.dispatchEvent(event);
              window.history.pushState({ activeContent: 'expense-claims-dashboard-form' }, '', '/');
            }}
