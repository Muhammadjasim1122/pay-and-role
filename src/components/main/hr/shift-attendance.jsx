  ...
  const shiftAttendanceReportsAndMasters = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Shift Report', link: '#', hasArrow: true },
        { name: 'Leave Report', link: '#', hasArrow: true },
        { name: 'Overtime Report', link: '#', hasArrow: true },
      ],
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          ...
          <div className="flex justify-between items-start p-6 pb-4">
            <div>
              <h1 className="text-1xl font-bold text-gray-900 mb-2">
                Let's Set Up the Shift & Attendance Module.
              </h1>
              <p className="text-gray-600">Shifts, Attendance, and more.</p>
            </div>
          ...
          <div className="px-6 py-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Shift & Attendance Shortcuts</h2>
          ...
          {/* Two Column Layout: Attendance Status (Left) and Reports (Right) */}
          <div className="px-6 py-6">
            <div className="grid grid-cols-5 gap-6">
              {/* Left Column - Attendance Status Section */}
              <div className="col-span-2">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="font-semibold text-gray-900">Attendance Status (Today)</h2>
                  </div>
