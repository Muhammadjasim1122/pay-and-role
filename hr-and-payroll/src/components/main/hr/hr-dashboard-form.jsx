...
export default function HRDashboardForm({ dashboardType = 'hr', isSidebarOpen = true }) {
  ...
  const handleCancel = () => {
    ...
    const targetContent = dashboardType === 'recruitment' ? 'recruitment-dashboard' : 'hr-dashboard';
