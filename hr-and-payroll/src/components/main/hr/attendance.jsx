...
export default function Attendance() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      const defaultData = [
        { id: 'ATT001', series: 'HR-ATT-2024-0001', employee: 'John Smith', attendanceDate: '2024-03-15', company: 'ACME Corp', status: 'Present' },
        { id: 'ATT002', series: 'HR-ATT-2024-0002', employee: 'Sarah Johnson', attendanceDate: '2024-03-15', company: 'ACME Corp', status: 'Present' },
        { id: 'ATT003', series: 'HR-ATT-2024-0003', employee: 'Michael Brown', attendanceDate: '2024-03-15', company: 'ACME Corp', status: 'Absent' },
      ];
  ...
  const handleDelete = (id) => {
    setOpenDropdown(null);
    setAlertMessage('Are you sure you want to delete this attendance record?');
    setAlertAction(() => () => {
  ...
  const filteredAttendances = attendances.filter(attendance => {
    ...
    const series = attendance.series || '';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Manage and track employee attendance</p>
          </div>
          <button 
            onClick={() => {
          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="Search by employee, series, or status..."
                ...
                {filteredAttendances.map((attendance) => (
                  <tr key={attendance.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {attendance.series || attendance.id}
                    </td>
        ...
        {openDropdown && (
          <>
            ...
            >
              <div className="py-1">
                {(() => {
                  const selectedAttendance = attendances.find(a => a.id === openDropdown);
