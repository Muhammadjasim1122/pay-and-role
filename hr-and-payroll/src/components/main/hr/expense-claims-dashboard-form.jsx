...
export default function ExpenseClaimsDashboardForm({ dashboardType = 'expense-claims', isSidebarOpen = true }) {
  ...
  const handleCancel = () => {
    ...
    window.history.pushState({ activeContent: 'expense-claims-dashboard' }, '', '/');
  };
