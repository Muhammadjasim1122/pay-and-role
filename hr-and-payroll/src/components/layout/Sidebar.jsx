        ...
        <div className="mt-0 space-y-0">
              ...
              <div>
                ...
                {expandedSections.payroll && (
                  <div className="pl-6 space-y-1 mt-1">
                    <button 
                      onClick={() => setActiveContent('payroll-dashboard')}
                      className={`w-full flex items-center space-x-2 px-3 py-1.5 text-[13px] transition-all duration-200 ease-in-out rounded-md ${
                        isContentActive('payroll-dashboard')
                          ? 'bg-gray-200 text-gray-800'
                          : 'text-gray-600 hover:bg-gray-50'
                      }`}
                    >
                    ...
                    <button 
                      onClick={() => setActiveContent('salary-slip')}
                      className={`w-full flex items-center space-x-2 px-3 py-1.5 text-[13px] transition-all duration-200 ease-in-out rounded-md ${
                        isContentActive('salary-slip')
                          ? 'bg-gray-200 text-gray-800'
                          : 'text-gray-600 hover:bg-gray-50'
                      }`}
                    >
                    ...
                    <button 
                      onClick={() => setActiveContent('salary-register')}
                      className={`w-full flex items-center space-x-2 px-3 py-1.5 text-[13px] transition-all duration-200 ease-in-out rounded-md ${
                        isContentActive('salary-register')
                          ? 'bg-gray-200 text-gray-800'
                          : 'text-gray-600 hover:bg-gray-50'
                      }`}
                    >
                    ...
                    <button 
                      onClick={() => setActiveContent('payroll-entry')}
                      className={`w-full flex items-center space-x-2 px-3 py-1.5 text-[13px] transition-all duration-200 ease-in-out rounded-md ${
                        isContentActive('payroll-entry')
                          ? 'bg-gray-200 text-gray-800'
                          : 'text-gray-600 hover:bg-gray-50'
                      }`}
                    >
