...
import PayrollDashboard from '../main/hr/payroll-dashboard';
import SalarySlip from '../main/hr/salary-slip';
import SalarySlipForm from '../main/hr/salary-slip-form';
import SalaryRegister from '../main/hr/salary-register';
import SalaryRegisterForm from '../main/hr/salary-register-form';
import PayrollEntry from '../main/hr/payroll-entry';
import PayrollEntryForm from '../main/hr/payroll-entry-form';
...
export default function Layout({ children }) {
  ...
  useEffect(() => {
    ...
    } else if (activeContent === 'payroll-dashboard') {
      // Update browser title
      document.title = 'Payroll Dashboard - HRM App';
    } else if (activeContent === 'salary-slip') {
      // Update browser title
      document.title = 'Salary Slip - HRM App';
    } else if (activeContent === 'salary-register') {
      // Update browser title
      document.title = 'Salary Register - HRM App';
    } else if (activeContent === 'payroll-entry') {
      // Update browser title
      document.title = 'Payroll Entry - HRM App';
    } else if (activeContent === 'salary-slip-form') {
      // Update browser title
      document.title = 'New Salary Slip - HRM App';
    } else if (activeContent === 'salary-register-form') {
      // Update browser title
      document.title = 'Generate Salary Register - HRM App';
    } else if (activeContent === 'payroll-entry-form') {
      // Update browser title
      document.title = 'New Payroll Entry - HRM App';
  ...
  useEffect(() => {
    const handlePopState = (event) => {
      ...
      } else if (event.state?.activeContent === 'payroll-dashboard') {
        setActiveContent('payroll-dashboard');
      } else if (event.state?.activeContent === 'salary-slip') {
        setActiveContent('salary-slip');
      } else if (event.state?.activeContent === 'salary-register') {
        setActiveContent('salary-register');
      } else if (event.state?.activeContent === 'payroll-entry') {
        setActiveContent('payroll-entry');
      } else if (event.state?.activeContent === 'salary-slip-form') {
        setActiveContent('salary-slip-form');
        setEditId(event.state?.editId || null);
      } else if (event.state?.activeContent === 'salary-register-form') {
        setActiveContent('salary-register-form');
        setEditId(event.state?.editId || null);
      } else if (event.state?.activeContent === 'payroll-entry-form') {
        setActiveContent('payroll-entry-form');
        setEditId(event.state?.editId || null);
  ...
  const renderContent = () => {
    ...
    return (
      <>
        {/* Sidebar - Hide for Leave Type, Leave Allocation, Leave Application, and User Settings */}
        {activeContent !== 'leave-type' && activeContent !== 'leave-allocation' && activeContent !== 'leave-application' && activeContent !== 'user-settings' && (
          <>
        ...
        >
          {activeContent === 'hr' ? <HR /> : activeContent === 'hr-dashboard' ? <HRDashboard /> : activeContent === 'dashboard-form' ? <HRDashboardForm dashboardType="hr" isSidebarOpen={isSidebarOpen} /> : activeContent === 'recruitment-dashboard-form' ? <HRDashboardForm dashboardType="recruitment" isSidebarOpen={isSidebarOpen} /> : activeContent === 'recruitment-dashboard' ? <RecruitmentDetails /> : activeContent === 'recruitment' ? <Recruitment /> : activeContent === 'lifecycle' ? <Lifecycle /> 
